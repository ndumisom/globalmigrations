...
<table width="100%"  cellpadding="3" cellspacing="3" border="0">
      <tr>
          <td height="47" colspan="3"><a href="index.php?m=task" onClick="loadPage( 'show_task', 'task_allocation.php','none' );"><b style="background-color: #0066FF; color: white; border:1px solid white;">Add Task</b></a>  <a href="index.php?m=show_task" onClick="loadPage( 'show_task', 'tasks.php','none' );"><b style="background-color: #0066FF; color: white; border:1px solid white;">refresh</a></td>
      </tr> 
      <tr>
