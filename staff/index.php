...
<html lang="en">
    ...
    <body>
        ...
        <div class="container">
            ...
            <p><a href="#" class="label label-info">View All Clients</a> <a href="index.php?page=status" class="label label-info" >Permit Status</a> <a href="index.php?page=task_request" class="label label-info">Tasks Request</a><p/>
