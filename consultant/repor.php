...
<html>
    ...
    <td>
            <h2 class="title"><a href="#" style="color: #0000FF; text-decoration: underline; font: Helvetica, Arial, sans-serif;">   <div class="table-head">ghgmhnj</div>Reports </a></h2>
            <p>&nbsp;</p>
    <center>
                 ...
                 <option value="Jacob Matasis">Jacob Matasis</option>
                    ...
                    <tr>
                        ...
                        <div class="input-daterange" id="datepicker" >
                            <input type="text" class="input-medium" placeholder="select startdate" name="start_date" />
                    ...
                    <tr>
                        ...
                        <div class="input-daterange" id="datepicker" >
                            <input type="text" class="input-medium" placeholder="select enddate" name="end_date" />
                            </div>
                        </td>
                    </tr>
                    <tr>
