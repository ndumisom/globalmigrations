...
background-color: #E02B2B;
    ...
    <body>
        ...
        <div class="container">
                    ...
                    <div class="navbar-inner">
                        ...
                        <div class="container">
                            <ul class="nav">
                                ...
                                <li><a href="index.php?page=message"><i class=" icon-envelope"></i> Message <span class="badge pull-right">42</span></a></li>
            ...
            <p><a href="index.php" class="label label-info">View All Clients</a> 
            ...
            <a href="index.php?page=quotes" class="label label-info">Quotes</a>
