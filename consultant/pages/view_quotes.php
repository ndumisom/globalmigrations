...
$strSQL = "SELECT * FROM quotes, quote_description WHERE quote_description.quote_id = quotes.quote_id AND quotes.quote_id ='$id' ";
$objQuery = mysql_query($strSQL);
$row = mysql_fetch_array($objQuery);
$result = mysql_query("SELECT *FROM quote_description WHERE  quote_id =$id");
...
<table border="0" width="80%" cellspacing="0" cellpadding="0" 
   ...
   <tr>
    ...
    <td bgcolor="#FFFFFF" width="144" ><?= $row['f_name'] ?></td>
  ...
  <tr>
    <td bgcolor="#FFFFFF" width="144" ><?= $row['consultant'] ?></td>
    <td bgcolor="#FFFFFF" width="144" ><?= $row['service'] ?></td>
    <td bgcolor="#FFFFFF" width="144"><?= $row['payment_terms'] ?></td>
    <td bgcolor="#FFFFFF" width="144">&nbsp;</td> 
  </tr>
  ...
  <?  $i = 0;
     ...
     ?><tr>
     <td bgcolor="#FFFFFF" width="70%" valign="top"><p><?= $row1['description'].''.count($row1['description']) ?></p><hr/></td>
     <td bgcolor="#FFFFFF" valign="top"><p><?= $row1['professional_fees'] ?></p><hr/></td>
     <td bgcolor="#FFFFFF" valign="top"><p><?=  $row1['saqa_dha_fees'] ?></p><hr/></td>
     <td bgcolor="#CCCCCC" valign="top"><p><?= $row1['line_total']  ?></p><hr/></td>
     </tr>
