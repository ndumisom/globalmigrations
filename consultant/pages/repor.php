...
<div class="form_header">
    <div class="header_body"><b style="color: #F5F5FA; text-align:center; font: Helvetica, Arial, sans-serif;">Reports</b></div><br/><br/><br/>
    </div>
  <div class="row">
     ...
     <table border="0" width="750" cellspacing="1" cellpadding="3" 
                    ...
                    <tr>
                        ...
                        <div class="form-group">
                                <select class="form-control" name="permit_status">
        ...
        <tr>
            <td bgcolor="#FFFFFF" width="60%">Start Date
         ...
         <tr>
           <td bgcolor="#FFFFFF" width="60%">End Date
                            <div class="form-group input-daterange">
