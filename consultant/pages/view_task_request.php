...
<!-- <center><a href="index.php?page=task_request"> <b style="background-color: #0066FF; color: white; border:1px solid white;"> << - back </b> </a></center> -->
    <center><span id="clear"><?php
            ...
            <form action="index.php?page=update_task_request" method="post">
                <table class="table table-bordered" border="0" cellspacing="0" cellpadding="0" width="100%" align="center" bordercolor="#0000CC" class="table">
					  <tr>
                        <td bgcolor="#FFFFFF" colspan=4 align="right">
                            ...
                            <div align="right">NO#<input type="text" disabled="disabled" name="task_requestID" value="<?php echo  $row['task_requestID'];?>" /><input type="hidden" name="task_requestID" value="<?php echo  $row['task_requestID'];?>" /></div>
                  
                        </td>
                   </tr>
					   <tr>
					   <td bgcolor="#FFFFFF" width="50%">Date<input type="hidden" name="clientID" value="<?php echo $row['clientID']; ?>"/></td><td bgcolor="#FFFFFF" ><input type="text" name="date_required" value="<?php echo $row['date_required']; ?>" id="date_r" autocomplete="off"/>
                                           
                                           </td>
					   <td bgcolor="#FFFFFF" width="30%"> File No</td><td bgcolor="#FFFFFF" ><input type="text" name="file_no" value="<?php echo $row['file_no']; ?>" autocomplete="off"/> </td>
					   
					   </tr>
					    <tr><td bgcolor="#FFFFFF" width="30%">Client Name</td><td bgcolor="#FFFFFF"><input type="text" name="client_name" value="<?php echo $row['surname']; ?> <?php echo $row['firstnames']; ?>" id="end_date" autocomplete="off"/></td>
					   <td bgcolor="#FFFFFF" width="50%">Required By</td><td bgcolor="#FFFFFF"><input type="text" name="required_by" value="<?php echo $row['required_by']; ?>" id="end_date" autocomplete="off"/> </td>
					   </tr>
					   <tr>
                        <td bgcolor="#FFFFFF" colspan=4 align="center">
                            <br/><u>Selected Task Request</u>
                        </td>
                       </tr>
					   <tr>
                        <td bgcolor="#FFFFFF" colspan=4 align="center">
			...
			for($i = 0; $i < count($read); $i++){
	            echo '<input type="checkbox" checked="yes" name="request[]" value="'.$read[$i].'"/> '.$read[$i].' <br/>';
                    ...
                    <tr>
						...
						<textarea rows="2" cols="90" name="request_other"><?php echo $row['request_other']; ?> </textarea> 
                    ...
                    <tr>
					  ...
					  <tr><td bgcolor="#FFFFFF" width="30%">Invoice Number</td><td bgcolor="#FFFFFF" ><input type="text" name="invoice_no" value="<?php echo $row['invoice_no']; ?>" autocomplete="off"/></td>
					   <td bgcolor="#FFFFFF" width="50%">Receipt Number</td><td bgcolor="#FFFFFF" ><input type="text" name="receipt_no" value="<?php echo $row['receipt_no']; ?>"  autocomplete="off"/> </td>
					   </tr>
					   <tr><td bgcolor="#FFFFFF" width="30%">Approved By</td><td bgcolor="#FFFFFF" ><input type="text" name="approved_by" value="<?php echo $row['approved_by']; ?>" autocomplete="off"/></td>
					   <td bgcolor="#FFFFFF" width="50%">Consultant</td><td bgcolor="#FFFFFF" ><input type="text" name="consultant" value="<?php echo $row['consultant']; ?>" autocomplete="off"/> </td>
					   </tr>
					    <tr><td bgcolor="#FFFFFF" width="30%" valign="top" >Allocated to</td><td bgcolor="#FFFFFF"><input type="text" name="allocated_to" value="<?php echo $row['allocated_to']; ?>"  autocomplete="off"/> <br/> Today's Date| <br/><input type="text" name="allocated_date" value="<?php echo $row['allocated_date']; ?>" id="f_date_a"  autocomplete="off"/></td>
						<script type="text/javascript">
...
<td bgcolor="#FFFFFF" width="50%" valign="top">Completed By</td><td bgcolor="#FFFFFF"><input type="text" name="completed_by" value="<?php echo $row['completed_by']; ?>"  autocomplete="off"/><br/> Date Completed| <br/><input type="text" name="completed_date" value="<?php echo $row['completed_date']; ?>" id="date_a" autocomplete="off"/></td>
					   <script type="text/javascript">
    function catcalc(cal) {
        var date = cal.date;
        var time = date.getTime()
        ...
        onUpdate       :    catcalc
                    ...
                    <tr>
                        ...
                        <input type="button" class="btn btn-primary" value="< Back" onclick="goBack()">
                            <input type="submit" name="Submit" value=" Save " class="login btn btn-primary"> 
                        </td>
