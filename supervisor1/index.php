    ...
    <body>
        ...
        <div class="container">
            ...
            <div class="masthead">
                ...
                <div class="search">
                    <?php                    require_once 'pages/action/search.php'; ?>
                </div>
                    ...
                    <div class="navbar-inner">
                        ...
                        <div class="container">
                            <ul class="nav">
                                ...
                                <li><a href="index.php?page=task"><i class="icon-list"></i> Tasks</a></li>
            ...
            <p>
            <a href="index.php?page=task" class="label label-info"> Allocate task</a>
            <a href="index.php" class="label label-info">View All Clients</a> 
            <a href="index.php?page=status" class="label label-info" >Permit Status</a> 
            <a href="index.php?page=task_request" class="label label-info">Tasks Request</a>
        ...
        <!-- <script src="http://code.jquery.com/jquery-latest.js"></script> -->
         ...
         <link rel="stylesheet" type="text/css" href="assets/css/datepicker.css"></link>
				...
				<?php require("pages/action/include_files.php"); ?>
