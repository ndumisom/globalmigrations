...
<table width="100%" cellspacing="0" cellpadding="0" border="1" bordercolor="#0000FF">
    ...
    <tr><td>
            ...
            $sql = "SELECT  *FROM client_details WHERE firstnames LIKE '%" . $name . "%' OR surname LIKE '%" . $name . "%'";
    ...
    <tr><td>
            ...
            <form name="task" action="add_task.php" method="post" class="uniForm" onsubmit="return validateTask()">
                <h3>Task Allocation </h3><input type="button" onclick="window.location.href='http://localhost/globalmigration/admin/index.php?page=sent_task'" value=" Sent " class="login"/> 
                    ...
                    <tr>
                        ...
                        <td>
                            <select name="allocated_task" id="allocated_task">
                                ...
                                <option value="Client assessment Form">Client assessment Form</option>
                                <option value="Quotation">Quotation</option>
                                <option value="Invoice">Invoice</option>
                                <option value="File Opening">File Opening</option>
                                <option value="Memo">Memo</option>
                                <option value="Consultant checks memo">Consultant checks memo</option>
                                <option value="Memo has been sent">Memo has been sent</option>
                                <option value="Received Memo at office">Received Memo at office</option>
                                <option value="Scruitner">Scruitner</option>
                                <option value="Cover Letter">Cover Letter</option>
                                <option value="Requisition for payment">Requisition for payment</option>
                                <option value="Copy of the application">Copy of the application</option>
                                <option value="Submission">Submission</option>
                                <option value="Collection / Drop off Docs">Collection / Drop off Docs</option>
                                <option value="Organ of State Letter">Organ of State Letter</option>
                                ...
                                <option value="SA Police Clearance">SA Police Clearance</option>
                                <option value="Translations Received">Translations Received</option>
                                <option value="Business Plan">Business Plan</option>
                                <option value="Airport 11(2) Letter">Airport 11(2) Letter</option>
                                <option value="Airport Departure letters">Airport Departure letters</option>
                                ...
                                <option value="Translations Requested">Translations Requested</option>
                                <option value="Benchmarking Requested">Benchmarking Requested</option>
                                <option value="SAQA">SAQA</option>
                                <option value="Request for Refund">Request for Refund</option>
                                <option value="Received Police Clearance">Received Police Clearance</option>
                                <option value="Requested Police Clearance">Requested Police Clearance</option>
                                <option value="Received Birth certificate">Received Birth certificate</option>
                    ...
                    <tr>
                        ...
                        <td><textarea name="details" id="details" cols="19" rows="5"><?
                                if ($userID) {
                                    ...
                                    echo $row1['firstnames'] . " " . $row1['surname'] . " " . $row1['file_no'];
                                } else {
