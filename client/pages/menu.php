...
<div id="refresh2"> 
<ul id="menu">
<li><a id="add" href="admin_index.php" onClick="loadPage( 'none', 'include_files.php');">Home</a></li>
<li><a href="admin_index.php?page=profile" onClick="loadPage( 'profile', 'profile.php');">My profile</a> </li>

    <li><a href="admin_index.php?page=msg"  onClick="loadPage( 'msg', 'msg.php');">
...
$num_messages = mysql_num_rows($get_messages);                  
 ...
 echo "<script>
                 ...
                 <li>
                     <a href="admin_index.php?page=show_task" onClick="loadPage( 'show_task', 'tasks.php');">Tasks<?php
