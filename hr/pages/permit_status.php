...
<?
echo ' <div class="style3" id="print_content"> <table id="ReportTable" class="table table-bordered" border="0" cellspacing="0" cellpadding="0" width="100%" align="center" bordercolor="#0000CC" class="table">';
echo '<tr class="header" valign="top">   
            ...
            <th>Expiry Date</th>
            <th>Permit Status</th>
            <th>Action&nbsp;&nbsp;&nbsp;<a href="javascript:window.print()"><div class="icon-print"></div></a></th></tr>';
...
<input type="hidden" id="datatodisplay" name="datatodisplay" >
                <input type="submit" value="Export per page" class="login btn btn-primary">       
    </form>

<?

$link = "index.php?page=permit_status"; // Page name
