<?php session_start(); 
 include_once 'redirect_permirt.php';
?>
...
<table class="tab" width="100%" border="0" cellpadding="0" cellspacing="0" bordercolor="#0000FF" >
    <tr>
        <td>
            <form name="permit" action="index.php?page=add_permit" method="post" class="uniForm" onsubmit="return validatePermit()">
                <h3><a href="#" style="color: #0000FF; text-decoration: underline; font: Helvetica, Arial, sans-serif;"> Permit Applications</a></h3>
...
?></div>
                    ...
                    <tr>
                        <td>Client id</td>
                        <td><input type="text" name="clientID" value="<?php echo $row['clientID']; ?>" disabled="disabled" size="36"/><input type="hidden" name="clientID" value="<?php echo $row['clientID']; ?>"/></td>
                    </tr>
                    <tr>
                        <td>Service</td>
				...
				<option value="Police clearance">Police clearance</option>
                                ...
                                <option value="Register of foreign birth">Register of foreign birth</option>
                            </select></td>
                    </tr>
                    <tr>
                        <td>Permit status </td>
