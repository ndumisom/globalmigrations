...
if($num>0){
    header("location:index.php?page=edit_request&id=".$clientID);
    exit;
}
else{
...
*/
    ...
    <center><span id="clear"><?
            ...
            <form action="p_task_request.php" method="post">
                <table border="0" width="750" cellspacing="1" cellpadding="3" 
					   ...
					   <td bgcolor="#FFFFFF" width="50%">Date</td><td bgcolor="#FFFFFF" ><input type="text" name="date_required" id="date_r" autocomplete="off"/>
                                               <script type="text/javascript">
    ...
    Calendar.setup({
        ...
        onUpdate       :    catcalc
                    ...
                    <tr>
					  ...
					  <tr><td bgcolor="#FFFFFF" width="30%">Invoice Number</td><td bgcolor="#FFFFFF" ><input type="text" name="invoice_no" autocomplete="off"/></td>
					   <td bgcolor="#FFFFFF" width="50%">Receipt Number</td><td bgcolor="#FFFFFF" ><input type="text" name="receipt_no"  autocomplete="off"/> </td>
					   </tr>
					   <tr><td bgcolor="#FFFFFF" width="30%">Approved By</td><td bgcolor="#FFFFFF" ><input type="text" name="approved_by" autocomplete="off"/></td>
					   <td bgcolor="#FFFFFF" width="50%">Consultant</td><td bgcolor="#FFFFFF" ><input type="text" name="consultant" value="<? echo $row['consultant']; ?>"  autocomplete="off"/> </td>
					    ...
					    <tr><td bgcolor="#FFFFFF" width="30%" valign="top" >Allocated to</td><td bgcolor="#FFFFFF"><input type="text" name="allocated_to"  autocomplete="off"/> <br/> Today's Date| <br/><input type="text" name="allocated_date" id="f_date_a"  autocomplete="off"/></td>
						<script type="text/javascript">
    function catcalc(cal) {
        var date = cal.date;
        var time = date.getTime()
    ...
    Calendar.setup({
        ...
        onUpdate       :    catcalc
					   ...
					   <td bgcolor="#FFFFFF" width="50%" valign="top">Completed By</td><td bgcolor="#FFFFFF"><input type="text" name="completed_by"  autocomplete="off"/> <br/> Date Completed| <br/><input type="text" name="completed_date" id="date_a" autocomplete="off"/></td>
					   <script type="text/javascript">
    function catcalc(cal) {
        var date = cal.date;
        var time = date.getTime()
