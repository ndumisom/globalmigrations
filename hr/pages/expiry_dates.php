...
echo '<div class="style3" id="print_content"><table class="tb" border="0" cellspacing="0" cellpadding="0" width="100%" align="center" bordercolor="#0000CC" class="table">';
	echo '<tr class="header" valign="top"><th>File no</th><th>Firstnames</th><th>Surname</th><th>Permit</th><th>Permit Status</th><th>Expiry Date &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="javascript:window.print()"><img title="print" src="images/Print.png" alt="print" width="40" height="27" /></a></th></tr>';
...
$link="admin_index.php?page=expiry"; // Page name
