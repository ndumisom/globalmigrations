...
if (isset($_GET['submit'])) {
    ...
    if (preg_match("/^[  a-zA-Z]+/", $_GET['name'])) {
        ...
        while ($row = @mysql_fetch_array($result)) {
            ...
            if ($isSearchFound) {
                ...
                echo "<tr class='r'><td bgcolor='aliceblue'>" . $row['file_no'] . "</td><td bgcolor='aliceblue'>" . $row['title'] . "</td><td bgcolor='aliceblue'>" . $row['firstnames'] . " </td><td bgcolor='aliceblue'>  " . $row['surname'] . " </td><td bgcolor='aliceblue'>" . $row['application_type'] . "</td><td bgcolor='aliceblue'>" . $row['passport_no'] . "</td><td bgcolor='aliceblue'>" . $row['corporate'] . "</td><td bgcolor='aliceblue'>" . $row['email'] . '</td><td bgcolor="aliceblue"><a style="color: #0000FF;" href="#"> <b>Send memo</b></a>|<a style="color: #0000FF;" href="index.php?page=edit_client&id=' . $row['clientID'] . '"> <b>Details</b></a>|<a style="color: #0000FF;" href="index.php?page=view_permit&id=' . $row['clientID'] . '"> <b>Permit</b></a> | <a style="color: #0000FF;" href="index.php?page=activity&id=' . $row['clientID'] . '"><b>Activity | <a style="color: #0000FF;" href="index.php?page=request&id=' . $row['clientID'] . '"><b>request</b></a>| <a style="color: #0000FF;" href="index.php?page=history&id=' . $row['clientID'] . '"><b>History</b></a></td></tr>';
            } else {
    ...
    $link = $_SERVER['PHP_SELF'].'?name='.$_GET['name'].'&submit=Search';//"index.php?page=search2"; // Page name
