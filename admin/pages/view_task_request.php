...
<center><a href="index.php?page=task_request"> <b style="background-color: #0066FF; color: white; border:1px solid white;"></b> </a></center>
    <center>                    <style>
 .wrap_froms {
    border: 2px solid;
    border-radius: 5px;
  ...
  <div class="row">
    <div class="offset1 span8 "><span id="clear"><?
...
<td bgcolor="#FFFFFF" width="50%" valign="top">Completed By</td><td bgcolor="#FFFFFF"><input type="text" name="completed_by" value="<? echo $row['completed_by']; ?>"  autocomplete="off"/><br/> Date Completed| <br/><input type="text" name="completed_date" value="<? echo $row['completed_date']; ?>" id="date_a" autocomplete="off"/></td>
    ...
    Calendar.setup({
        ...
        onUpdate       :    catcalc
                    ...
                    <tr>
                        <td bgcolor="#FFFFFF" colspan=4 align="right">
                        <input type="button" value="< Back" onclick="goBack()" class="login btn btn-primary"/>
                            <input type="submit" name="Submit" value=" Save " class="login login btn btn-primary"> 
                        </td>
