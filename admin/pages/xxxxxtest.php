                    ...
                    unset($_SESSION['error']);
                                ...
                                <div class="present">
                                    <form method="post" action="delete_msg.php">
                                        ...
                                        <table  width="100%" cellpadding="2" cellspacing="2" border="0">
                                            <tr>
                                                <td height="47" colspan="3"><div class='cssmenu'> <ul><li><input type="submit" name="del_mult" id="search-submit"  value="delete" class="login"/></li><li><a href="index.php?page=compose" alt="Write new message"> Compose</a></li><li><a href="index.php?page=sent_msg" alt="Sent messages"> Sent</a></li><li><a href="index.php?page=msg" onClick="loadPage( 'msg', 'msg.php');" >refresh</a></li></ul></div><br /></td>
                                            </tr> 
                                            <tr >
