 ...
 <?php $t = 0; while( $row = mysql_fetch_array( $Query ) ) { 
  ...
  ?>     
      <tr>
          ...
          <td>
           <?php echo strip_tags( substr($row['allocated_task'],0,35));?><a href="index.php?page=view&id=<?php echo $row['task_all_id'];?>" onClick="loadPage( 'view', 'include_files.php', '<?php echo $row['task_all_id'];?>' );">...read more</a>
          </td>
  ...
  <?php    } else { ?>
      <tr bgcolor="#D8D8D8">
          ...
          <td>
           <b><?php echo strip_tags( substr($row['allocated_task'],0,35));?><a href="index.php?page=view&id=<?php echo $row['task_all_id'];?>" onClick="loadPage( 'view', 'include_files.php', '<?php echo $row['task_all_id'];?>' );">...read more</a></b>
          </td>
