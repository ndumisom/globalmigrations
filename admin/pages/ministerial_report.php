...
<table class="tab" width="100%" cellspacing="0" cellpadding="0" border="0" bordercolor="#0000FF">
    <tr><td>
            ...
            <p>&nbsp;</p>
    <center>
        <a href="index.php?page=reports" style="color: ; text-decoration: ; font: Helvetica, Arial, sans-serif;"class="label label-info"> <b>Normal Report</b></a></a><br/><br/>
            <form action="index.php?page=view_ministerial_report" method="post">
                <table border="0" width="750" cellspacing="1" cellpadding="3" 
                    ...
                    <tr>
                        ...
                        <td bgcolor="#FFFFFF">
                             <select name="hr_department" id="level" >
                                <option value="">Select</option>
