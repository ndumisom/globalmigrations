...
<td>
 ...
 while ($row= mysql_fetch_array($objQuery)){
     echo "<tr class='row'>
      ...
      <td> ".$row['comments']."</td>
      <td><a style='color: #0000FF;' href='index.php?page=e_permit&id=".$row['permit_appID']."'> <b> Edit </b></a>|<a style='color: #0000FF;' href='index.php?page=new_permit&id=".$row['clientID']."'> <b> New </b></a></td>
    </tr>";
 }if($numrows == 0) {
