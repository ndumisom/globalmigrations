...
<table class="tab" width="100%" cellspacing="0" cellpadding="0" border="0" bordercolor="#0000FF">
    <tr><td>
            ...
            <p>&nbsp;</p>
    <center>
            <form action="index.php?m=view_report" method="post">
...
<tr>
 <td bgcolor="#FFFFFF">Start Date</td>
    <div class="input-daterange" id="datepicker" >
                    <input type="text" class="input-small" name="start" /></div>
               
                               
</tr> <tr><td bgcolor="#FFFFFF" width="50%">End Date</td>
                  <div class="input-daterange" id="datepicker" >
                    <span><input type="text" class="input-small" name="end" /></span></div>
                </div>
