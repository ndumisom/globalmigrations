...
$call = new globalm; 
 ...
 <div class="present">
  <div align="left">
  <a href="delete_task.php?id=<?php echo $row['task_all_id'];?>" onclick="return confirm('Are you sure you have completed the task?');" id="search-submit" ><b style="background-color: #0066FF; color: white; border:1px solid white; text-decoration:none;">Completed</b></a>  
  <a href="cancel_task.php?id=<?php echo $row['task_all_id'];?>" onclick="return confirm('Are you sure you cancel the task?');" id="search-submit" ><b style="background-color: #0066FF; color: white; border:1px solid white; text-decoration:none;">Cancel Task</b></a>
  </div>
  <br />
