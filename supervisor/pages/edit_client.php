...
<div class="container wrap_froms">
  <div class="row">
    <div class="offset1 span8 ">
        <form name="client" action="update_client_details.php?id=<?php echo $id; ?>" method="post" onsubmit="return validateClient()">
    <h3 style="color: #0000FF; text-align: center; font: Helvetica, Arial, sans-serif;" > <a href="#" style="color: #0000FF; font: Helvetica, Arial, sans-serif;"><b>Details of a client </b></a></h3>
...
if( isset($_SESSION['error']) ){echo '<span id="error">'. $_SESSION['error'].'</span>'; unset($_SESSION['error']);}
  ...
  ?>
    ...
    <tr>
      ...
      <td width="21%"><input type="text" name="file_no" id="file_no" size="30" value="<?php $objResult["file_no"];?>" disabled="disabled"/></td>
      <td width="10%">&nbsp;</td>
      <td width="27%">Mobile Number </td>
      <td width="24%"><input type="text" name="mobile_no" id="mobile_no" size="30" value="<?php $objResult['mobile_no'] ?>" disabled="disabled"/></td>
    </tr>
    <tr>
      <td>Title</td>
    ...
    <tr>
      ...
      <td>&nbsp;</td>
      <td>country</td>
      <td><input type="text" name="counrty_of_origin" size="30" value="<?php echo $objResult['country_of_origin'] ?>" disabled="disabled"/></td>
    </tr>
    <tr>
    ...
    <tr>
      <td><input type="button" class="btn btn-primary" value="< Back" onclick="goBack()" class="login"/></td>
      <td>&nbsp;</td>
      <td>&nbsp;</td>
      <td>&nbsp;</td>
      <td></td>c
