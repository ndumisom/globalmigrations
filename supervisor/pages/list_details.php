        ...
        <tr >
            <td valign="top">
                ...
                <table>
                    <tr>
                        <td valign="top">
                            ...
                            $Query = $paging->pagerQuery("SELECT * FROM  `process_task_allocation` WHERE details='$details' GROUP BY task_all_id DESC", $rowsPerPage) or die(mysql_error());
                            ?>
                            <div class="post">
                                <div class="entry">
                                    <p><?php
                            ...
                            ?></p>
                                    <div align="left"><a href="index.php?m=sent_task" class="label label-info"><b style="">  back </b></a> </div><br/><br/>
               ...
               <tr style="background-color: #0088cc; color: #FFF;">
                                                    ...
                                                    <td width="400"><em><strong>Status &nbsp;&nbsp;&nbsp;&nbsp;<a href="javascript:window.print()"><div class="icon-print"></div></a></strong></em></td>
                                                </tr>
<?php $t = 0;
