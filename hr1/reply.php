...
<p><?
 ...
 <div class="present">
  <div align="left"><a href="delete_msg.php?id=<?php echo $row['msg_id'];?>" id="search-submit" > <b style="background-color: #0066FF; color: white; border:1px solid white; text-decoration:none;"> &nbsp;&nbsp; Delete&nbsp;&nbsp;  </b></a> </div>
  <br />
 <p> <b>To  &nbsp;&nbsp;&nbsp;: </b><a style="color: #0000FF;" href="#"><?php echo $row['sender'].'';?>  </a></p>
 <p><b>Date : </b><a style="color: #0000FF;" href="#"><?php echo $row['msg_date'].'<br />';?></a></p>
