  ...
  //session_start();
   $id = $_GET["id"];
	...
	$strSQL = "SELECT * FROM task_request,client_details WHERE task_request.clientID = '$id' AND client_details.clientID = '$id'";
 ...
 .wrap_froms {
  ...
  <div class="row">
    <div class="offset1 span8 ">
            ...
            <form action="index.php?page=p_edit_task_request" method="post">
                ...
                <table border="0" width="750" cellspacing="1" cellpadding="3" 
                     ...
                     <tr>
                        <td bgcolor="#FFFFFF" colspan=4 align="right">
                            ...
                            <div align="right">NO#<input type="text" disabled="disabled" name="task_requestID" value="<? echo  $row['task_requestID'];?>" /></div>
