...
<p>
 ...
 <div class="present">
  <div align="left">
  <b><a href="admin_index.php?page=reply&id=<?php echo $row['msg_id'];?>" id="search-submit" onClick="loadPage( 'reply', 'reply.php');" ><b style="background-color: #0066FF; color: white; border:1px solid white; text-decoration:none;"> &nbsp;&nbsp; Reply&nbsp;&nbsp;  </b> </a>&nbsp;&nbsp;
  <b><a href="delete_msg.php?id=<?php echo $row['msg_id'];?>" id="search-submit" onclick="return confirm('Are you sure you want to delete?')"><b style="background-color: #0066FF; color: white; border:1px solid white; text-decoration:none;"> &nbsp;&nbsp; Delete&nbsp;&nbsp;  </b></a></b>  </div>
  <p><br />
    <b>From &nbsp;&nbsp; : </b><a href="#" style="color: #0000FF;"><?php echo $row['sender'].'';?></a> 
    </p>
