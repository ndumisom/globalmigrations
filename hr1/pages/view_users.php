...
echo '<tr class="header" valign="top"><th>Usernam<th>Firstnames</th><th>Surname</th><th>Email</th></tr>';
	...
	while($data=mysql_fetch_assoc($result)){
	    ...
	    echo '<tr class="r"><td>' . $data['username'] . '</td><td>' . $data['firstname'] . '</td><td>' . $data['surname'] . '</td><td>' . $data['email'] . '</td><tr>' ;
...
$link="index.php?page=view_users"; // Page name
