...
<table class="tab" width="100%" cellspacing="0" cellpadding="0" border="0" bordercolor="#0000FF">
    ...
    <center>
        ...
        <a href="index.php?page=reports" style="color: ; text-decoration: ; font: Helvetica, Arial, sans-serif;" class="label label-info"> <b>Normal Report</b></a><br/><br/>
            <form action="index.php?page=view_empty" method="post">
