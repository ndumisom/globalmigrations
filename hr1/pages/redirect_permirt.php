...
if($destination_country == 'Botswana' ){
  ...
  header("location:admin_index.php?page=botswana&id=$clientID");
    exit;
}
else if ($destination_country == 'Burundi') {
    
    header("location:admin_index.php?page=burundi&id=$clientID");
    exit;

}
else if($destination_country == 'Ethiopia' ){
    
    header("location:admin_index.php?page=ethiopia&id=$clientID");
    exit;
}
else if($destination_country == 'Kenya' ){
    
   header("location:admin_index.php?page=kenya&id=$clientID");
    exit;
}
else if($destination_country == 'Malawi' ){
    
    header("location:admin_index.php?page=malawi&id=$clientID");
    exit;
}
else if($destination_country == 'Mauritius' ){
    
   header("location:admin_index.php?page=mauritius&id=$clientID");
    exit;
}
else if($destination_country == 'Mozambique' ){
    
   header("location:admin_index.php?page=mozambique&id=$clientID");
    exit;
}
else if($destination_country == 'Rwanda' ){
    
  header("location:admin_index.php?page=rwanda&id=$clientID");
    exit;
}
else if($destination_country == 'Tanzania' ){
    
   header("location:admin_index.php?page=tanzania&id=$clientID");
    exit;
}
else if($destination_country == 'Uganda' ){
    
   header("location:admin_index.php?page=uganda&id=$clientID");
    exit;
}
else if($destination_country == 'Zimbabwe' ){
    
   header("location:admin_index.php?page=zimbabwe&id=$clientID");
    exit;
}
else if($destination_country == 'Zambia' ){
    
   header("location:admin_index.php?page=zambia&id=$clientID");
    exit;
}
